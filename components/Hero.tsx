    ...
    <section className="w-full">
      <div className="sm:flex sm:flex-row-reverse justify-between items-center gap-4 max-w-[1500px] mx-auto px-6 lg:px-20">
        ...
        <div className="mx-auto sm:mx-0">
          <h1 className="text-[32px] font-[CharlevoixPro] leading-none lg:text-7xl font-bold max-w-[710px] mb-2 lg:mb-8">
            Alimentar bien a tu perro es más fácil que nunca
            <span className="text-primary">.</span>
          </h1>
          <h2 className="text-[16px] font-bold lg:text-[22px] opacity-60 lg:leading-7 max-w-[652px]">
